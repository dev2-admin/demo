...
var KTFlotchartsDemo = function() {
    ...
    var demo8 = function() {
        var data = [
            { label: "CSS", data: 10, color: "#01b091" },

            { label: "HTML5", data: 40, color: "#038dfd" },
            { label: "PHP", data: 30, color: "#ec7362 " },
            { label: "Angular", data: 20, color: "#8a70eb " }
        ];
    ...
    var demo9 = function() {
        var data = [
            { label: "USA", data: 10, color: "#01b091" },
            { label: "Germany", data: 25, color: "#038dfd" },
            { label: "Norway", data: 30, color: "#8a70eb" },
            {
                label: "Malaysia",
                data: 15,
                color: "#ec7362"
    ...
    var demo10 = function() {
        var data = [
            { label: "Google", data: 20, color: "#01b091" },
            { label: "Twitter", data: 35, color: "#038dfd" },
            { label: "Linkedin", data: 20, color: "#8a70eb" },
            { label: "Instagram", data: 25, color: "#ec7362" },
            {
                label: "Facebook",
                data: 10,
                color: "#4eaefd"
    ...
    var demo11 = function() {
        var data = [
            { label: "Vue", data: 13, color: "#01b091" },
            {
                label: "Angular",
                data: 25,
                color: "#038dfd"
            },
            { label: "React", data: 15, color: "#8a70eb" },
            { label: "Ember", data: 10, color: "#ec7362" },
            { label: "Backbone", data: 8, color: "#4eaefd" }
        ];
