...
var KTDashboard = function() {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHoverBackgroundColor: "#ec7362",
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHoverBackgroundColor: '#ec7362 ',
                    pointHoverBorderColor: Chart.helpers.color("#ec7362").alpha(0.2).rgbString(),
                    data: [
                        10, 20, 16,
                        18, 12, 40,
                        35, 30, 33,
    ...
    var salesByApps = function() {
        ...
        _initSparklineChart($('#kt_chart_sales_by_apps_1_1'), [10, 20, -5, 8, -20, -2, -4, 15, 5, 8], "#8a70eb", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_1_2'), [2, 16, 0, 12, 22, 5, -10, 5, 15, 2], "#ec7362", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_1_3'), [15, 5, -10, 5, 16, 22, 6, -6, -12, 5], "#01b091", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_1_4'), [8, 18, -12, 12, 22, -2, -14, 16, 18, 2], "#038dfd", 2);

        _initSparklineChart($('#kt_chart_sales_by_apps_2_1'), [10, 20, -5, 8, -20, -2, -4, 15, 5, 8], "#8a70eb", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_2'), [2, 16, 0, 12, 22, 5, -10, 5, 15, 2], "#01b091", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_3'), [15, 5, -10, 5, 16, 22, 6, -6, -12, 5], "#01b091", 2);
        _initSparklineChart($('#kt_chart_sales_by_apps_2_4'), [8, 18, -12, 12, 22, -2, -14, 16, 18, 2], "#038dfd", 2);
    }
    ...
    var latestUpdates = function() {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    label: "Sales Stats",
                    backgroundColor: "#ec7362", // Put the gradient here as a fill color
                    borderColor: "#ec7362",
                    pointBackgroundColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
                    pointBorderColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
                    pointHoverBackgroundColor: "#01b091",
                    pointHoverBorderColor: Chart.helpers.color('#000000').alpha(0.1).rgbString(),
    ...
    var trendsStats2 = function() {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    label: "Sales Stats",
                    backgroundColor: "#038dfd", // Put the gradient here as a fill color
                    borderColor: "#038dfd",
    ...
    var activitiesChart = function() {
        ...
        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#f7c2bb').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#f7c2bb').alpha(0.3).rgbString());
    ...
    var bandwidthChart1 = function() {
        ...
        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#b3fff1').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#b3fff1').alpha(0.3).rgbString());
    ...
    var bandwidthChart2 = function() {
        ...
        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#9ad1fe').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#9ad1fe').alpha(0.3).rgbString());
    ...
    var orderStatistics = function() {
        ...
        var barChartData = {
            ...
            datasets: [{
                    fill: true,
                    //borderWidth: 0,
                    backgroundColor: color("#ec7362").alpha(0.6).rgbString(),
                    borderColor: color("#ec7362").alpha(0).rgbString(),
                ...
                },
                {
                    fill: true,
                    //borderWidth: 0,
                    backgroundColor: color("#038dfd").alpha(0.2).rgbString(),
                    borderColor: color("#038dfd").alpha(0).rgbString(),

                    pointHoverRadius: 4,
                    pointHoverBorderWidth: 12,
                    pointBackgroundColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
                    pointBorderColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
                    pointHoverBackgroundColor: "#038dfd",
                    pointHoverBorderColor: Chart.helpers.color('#000000').alpha(0.1).rgbString(),
    ...
    var quickStats = function() {
        _initSparklineChart($('#kt_chart_quick_stats_1'), [10, 14, 18, 11, 9, 12, 14, 17, 18, 14], "#038dfd", 3);
        _initSparklineChart($('#kt_chart_quick_stats_2'), [11, 12, 18, 13, 11, 12, 15, 13, 19, 15], "#ec7362", 3);
        _initSparklineChart($('#kt_chart_quick_stats_3'), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], "#01b091", 3);
        _initSparklineChart($('#kt_chart_quick_stats_4'), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], "#01b091", 3);
    }
